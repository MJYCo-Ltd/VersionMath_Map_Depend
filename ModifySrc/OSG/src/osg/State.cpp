...
void State::initUpModeDefineMaps()
{
    ...
    _textureFormat = new IntArrayUniform("osg_TextureFormat", _glMaxTextureUnits);

    _textureModeDefineMapList.resize(_glMaxTextureUnits);
    for(unsigned int i=0; i< _glMaxTextureUnits; ++i)
    {
