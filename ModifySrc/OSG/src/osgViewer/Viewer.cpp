...
Viewer::Viewer(osg::ArgumentParser& arguments)
{
    ...
    arguments.getApplicationUsage()->addCommandLineOption("--CullThreadPerCameraDrawSingle", "Select CullThreadPerCameraDrawSingle threading model for viewer.");
    ...
    while (arguments.read("--CullThreadPerCameraDrawSingle")) setThreadingModel(CullThreadPerCameraDrawSingle);
...
void Viewer::take(osg::View& rhs)
{
    ...
    if (rhs_viewer)
    {
        ...
        _endCullBarrier = rhs_viewer->_endCullBarrier;
...
void Viewer::eventTraversal()
{
    ...
    double endEventTraversal = elapsedTime();
    double expendEventTraversal = endEventTraversal - beginEventTraversal;
    if (expendEventTraversal > 1)
    {
        OSG_WARN << "Event traversal time taken so long" << expendEventTraversal << std::endl;
    }
    ...
    if (getViewerStats() && getViewerStats()->collectStats("event"))
    {
        ...
        getViewerStats()->setAttribute(_frameStamp->getFrameNumber(), "Event traversal time taken", expendEventTraversal);
    }
...
void Viewer::updateTraversal()
{
    ...
    double expendUpdateTraversal = endUpdateTraversal - beginUpdateTraversal;
    if (expendUpdateTraversal > 1)
    {
        OSG_WARN << "Update traversal time taken so long" << expendUpdateTraversal << std::endl;
    }
    ...
    if (getViewerStats() && getViewerStats()->collectStats("update"))
    {
        ...
        getViewerStats()->setAttribute(_frameStamp->getFrameNumber(), "Update traversal time taken", expendUpdateTraversal);
    }
}
